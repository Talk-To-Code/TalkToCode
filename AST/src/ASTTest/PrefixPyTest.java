...
public class PrefixPyTest extends TestCase {
	private static ASTParser parser;
	@Test
	public void testPrefix() {
		try {
			InputStream in = new FileInputStream(new File("./input/Prefixinput.txt"));
			BufferedReader inBR = new BufferedReader(new InputStreamReader(in));
			FileChannel inChannel = ((FileInputStream) in).getChannel();
			InputStream out = new FileInputStream(new File("./output/PrefixoutputPy.txt"));
