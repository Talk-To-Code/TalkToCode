 ...
 * this class is mainly in charge of syntax generation of comments in C Programs
 */
public class ASTCommentC extends ASTComment {
	...
	public String toSyntax() {
		...
		if(this.commentedOutLines.isEmpty()) {
			...
			for(ASTStatement s : this.statements) {
				for(String str : s.toSyntax().split("\n")) code.add(str);
			}
